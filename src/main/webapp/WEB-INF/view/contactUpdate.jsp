...
<ol class="breadcrumb">
    ...
    <li class="active">Редктирование контакта</li>
</ol>
<c:if test="${not empty error_update}" scope="session" var="result">
    <div class="alert alert-danger">${error_update}</div>
    <c:remove var="error_update" scope="session" />
</c:if>
...
<div class="starter-template">
    <div class="panel panel-default">
        <div class="panel-heading">
            <span class="panel-title">Редактирование контакта</span>
        </div>
        <div class="panel-body">
            <form action="/contact-update" method="post" class="">
